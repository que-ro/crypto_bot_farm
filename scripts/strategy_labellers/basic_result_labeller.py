...
class BasicResultLabeller(StrategyResultLabellerInterface):

    def __init__(self, df_products):

        self.name = 'BasicLabeller'
    ...
    def get_df_product_with_strat_result_label(self) -> object:
        ...
        is_gain_loss_perc_sup = self.df_products['gain_loss_percentage'] >= 0.1
        is_nb_sold_sup_2 = self.df_products['nb_sold_order'] > 1
